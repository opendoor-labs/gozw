...
const (
	...
	DoorLockV4                                 CommandClassID = 0x62
	...
	IndicatorV3                                CommandClassID = 0x87
	...
	MeterTblMonitorV3                          CommandClassID = 0x3D
	...
	NetworkManagementInclusionV3               CommandClassID = 0x34
	...
	SensorMultilevelV11                        CommandClassID = 0x31
	...
	UserCodeV2                                 CommandClassID = 0x63
	Version                                    CommandClassID = 0x86
	VersionV2                                  CommandClassID = 0x86
	VersionV3                                  CommandClassID = 0x86
	...
	ScheduleV4                                 CommandClassID = 0x53
	...
	NetworkManagementInstallationMaintenanceV2 CommandClassID = 0x67
...
func (c CommandClassID) String() string {
	...
	case NodeProvisioning:
		return "Command Class Node Provisioning"

	case SoundSwitch:
		return "Command Class Sound Switch"
